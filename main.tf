locals {
  ...
  name                           = "${lower(replace(local.name_or_context, "/var.regex_allowed/", ""))}"
  ...
  namespace                      = "${lower(replace(local.namespace_or_context, "/var.regex_allowed/", ""))}"
  ...
  environment                    = "${lower(replace(local.environment_or_context, "/var.regex_allowed/", ""))}"
  ...
  stage                          = "${lower(replace(local.stage_or_context, "/var.regex_allowed/", ""))}"
