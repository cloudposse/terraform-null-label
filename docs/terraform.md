...
| <a name="input_root_module_tag_enabled"></a> [root\_module\_tag\_enabled](#input\_root\_module\_tag\_enabled) | If true, the last component of the Terraform root module directory will be added as a `Root_module` to the tags. | `bool` | `false` | no |
